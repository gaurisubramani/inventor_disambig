...
class InventorVars(
  ...
  def this(dim: Int) = this(new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new DenseDoubleBagVariable(dim), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), new BagOfWordsVariable(), "", new BagOfWordsVariable(), "")

  def this() = this(200)

  def getVariables = Seq(firstNames, middleNames, lastNames, locations, applicationIds, applicationTypes, applicationCountry, dates, patentCountry, patentTypes, title, titleEmb, keywords, coInventors, assignees, lawyers, lawyersLocations, uspc)
